...
export const Header = () => {
  return (
    <header style={backgroundStyle} className="min-h-[100vh] w-[100%]">
      ...
      <div className="min-h-[90vh] flex flex-col gap-5 items-center justify-center text-center">
        ...
        <h1 className="animate__animated animate__fadeInUp mystic-title text-[#e59205] text-5xl">Mystic Taste.</h1>
        <p className="animate__animated animate__fadeInUp w-[95%] sm:w-[70%] md:w-[60%] text-white">
          ...
          cuidadosamente diseñado para ofrecer momentos inolvidables en la mesa.
        </p>
      </div>
    </header>
  );
